		  ...
		  <li>
            ...
            <ul class="dropdown-menu">
			  ...
			  <li><a href="./passwd.php">修改密码</a></li>
			    <li><a href="https://www.freelibrary.top">辰沙资源</a></li>
            </ul>
          </li>
    ...
    <div class="col-xs-12 col-sm-10 col-lg-8 center-block" style="float: none;">
      <div class="panel panel-primary">
        <div class="panel-heading"><h3 class="panel-title">后台首页</h3></div>
          <ul class="list-group">
            <li class="list-group-item"><span class="glyphicon glyphicon-stats"></span> <b>礼尚往来</b> 共有:<?=$sum?>人！</li>
            ...
            <li class="list-group-item"><span class="glyphicon glyphicon-list"></span> <b>功能菜单：</b> 
              <a href="./add.php" class="btn btn-xs btn-success">添加随礼记录</a>
